...
LL_Node* create_stdlib_symbol_table() {
    ...
    lib[2]->func = func_create(1, (VarType[]){TYP_ANY}, TYP_CHARACTER);
    lib[3]->func = func_create(1, (VarType[]){TYP_ANY}, TYP_FLOAT);
    lib[4]->func = func_create(1, (VarType[]){TYP_ANY}, TYP_BOOLEAN);
